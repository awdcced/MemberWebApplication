...
namespace MemberWebApplication.Models
{
    ...
    public partial class MemberManagementSystemDBEntities : DbContext
    {
        public MemberManagementSystemDBEntities()
            : base("name=MemberManagementSystemDBEntities")
        {
        }
        ...
        public virtual DbSet<ConsumptionOrders> ConsumptionOrders { get; set; }

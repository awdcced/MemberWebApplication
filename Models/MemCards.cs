...
namespace MemberWebApplication.Models
{
    ...
    public partial class MemCards
    {
        ...
        public MemCards()
        {
            this.ConsumptionOrders = new HashSet<ConsumptionOrders>();
        }
        ...
        public Nullable<byte> MC_IsPast { get; set; }
        ...
        public Nullable<byte> MC_IsPointAuto { get; set; }
        ...
        public virtual ICollection<ConsumptionOrders> ConsumptionOrders { get; set; }
